...
async def process_with_rag(file_paths: list[str],
                           output_dir: str,
                           api_key: str,
                           base_url: str = "",
                           working_dir: str = "",
    ...
    try:
        ...
        #     file_paths=file_paths, output_dir=output_dir, parse_method="auto", lang="en", source="local"
        # )
...
def main():
    ...
    parser.add_argument("file_path", default="./data", help="Path to the document to process")
    ...
    parser.add_argument("--api-key", default=os.getenv("LLM_BINDING_API_KEY"), help="OpenAI API key (defaults to LLM_BINDING_API_KEY env var)")
    
    parser.add_argument("--base-url", default=os.getenv("LLM_BASE_URL"), help="Optional base URL for API")

    parser.add_argument("--parser", default=os.getenv("PARSER", "mineru"), help="Optional parser to use")
    ...
    # default
    args.file_path = ["./data/[2012]_ImageNet_Classification_with_Deep_Convolutional_Neural_Networks.pdf"]
