...
if TYPE_CHECKING:
    from test.utils import RAGAnythingConfig
...
class BatchMixin:
    ...
    def process_documents_batch(self, file_paths: List[str], output_dir: Optional[str] = None,
                                parse_method: Optional[str] = None, max_workers: Optional[int] = None,
                                recursive: Optional[bool] = None, show_progress: bool = True, **kwargs) -> BatchProcessingResult:
        """
        ---
        Note:
        ---
