...
class BatchParser:
    ...
    def __init__(self, parser_type: str = "mineru", max_workers: int = 4, show_progress: bool = True, 
                 timeout_per_file: int = 300, skip_installation_check: bool = False,
    ):
        """
    ...
    def process_single_file(
        ...
        try:
            ...
            # print(f"Processing {file_path} with output to {file_output_dir}")
            # Parse the document
            ...
            # print(f"Finished processing {file_path} with {len(content_list)} content blocks")
