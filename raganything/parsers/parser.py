...
class Parser:
    ...
    @classmethod
    def convert_office_to_pdf(cls, doc_path: Union[str, Path], output_dir: Optional[str] = None) -> Path:
        """
        ---
        Note:
        ---
    ...
    @classmethod
    def convert_text_to_pdf(cls, text_path: Union[str, Path], output_dir: Optional[str] = None) -> Path:
        """
        ---
        Note:
        ---
    ...
    def parse_image(self, image_path: Union[str, Path], output_dir: Optional[str] = None,
        ...
        Must be implemented by subclasses.
        Different parsers may support different image formats.
